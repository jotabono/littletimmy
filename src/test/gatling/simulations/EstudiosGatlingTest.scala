...
/**
 * Performance test for the Estudios entity.
 */
class EstudiosGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Estudios entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created estudios")
                .get("${new_estudios_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created estudios")
            .delete("${new_estudios_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
