...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "littletimmy@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "littletimmy API";

        private String description = "littletimmy API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "littletimmy";
